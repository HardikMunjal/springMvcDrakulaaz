...
<c:url var="Client" value="saveClient"/>  
<form:form id="registerForm2" modelAttribute="newSurvey" method="post" action="${Client}">  
...
<tr>  
<td><form:label path="ClientRole">user role</form:label></td>  
<td><form:input  path="ClientRole"/></td>  
</tr>
